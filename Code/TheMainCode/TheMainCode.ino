...
void loop()
{
 ...
 //Serial.print("computed " + String(output));
 ...
 Serial.println("input " + String(input) + " output " + String(output) + " average " + String(average));
