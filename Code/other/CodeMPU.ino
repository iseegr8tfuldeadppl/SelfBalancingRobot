...
void setup() {
  ...
  // CALIBRATION!!
  /*for ( cal = 0; cal < 201; cal++){ // old: 2000
    ...
    Serial.print("accXcal: "); Serial.println(accXcal);
    Serial.print("accYcal: "); Serial.println(accYcal);
    Serial.print("accZcal: "); Serial.println(accZcal);
    Serial.print("gyroXcal: "); Serial.println(gyroXcal);
    Serial.print("gyroYcal: "); Serial.println(gyroYcal);
    Serial.print("gyroZcal: "); Serial.println(gyroZcal);
    delay(2000);
...
*/
  ...
  // anglePitchOutput = 0.9 * anglePitchOutput + anglePitch * 0.1;  // //Take 90% of the output pitch value and add 10% of the raw pitch value
   ...
   Serial.println("gyroX " + String(gyroX, DEC) + " accX " + String(accX, DEC));
   Serial.println("gyroY " + String(gyroY, DEC) + " accY " + String(accY, DEC));
   Serial.println("gyroZ " + String(gyroZ, DEC) + " accZ " + String(accZ, DEC));
